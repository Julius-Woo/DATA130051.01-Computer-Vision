...
parser.add_argument('--sub-ratio', default=1.0, type=float,
                    help='Percentage of the dataset to use as a subset')
...
def main():
    ...
    # Get Full dataset
    full_dataset = dataset.get_dataset(args.dataset_name, args.n_views)
    
    # Get Subset of the dataset
    subset_size = int(len(full_dataset) * args.sub_ratio)
